...
set nolabel
set label 1 "{/Symbol e}_F" at EF, 26, 0 left norotate
set noarrow
...
plot "dosdat.bin.plot" u 2:4 t "Total DOS" w l,     "dosdat.bin.plot" u 2:5 t "DOS---s" w l,     "dosdat.bin.plot" u 2:6 t "DOS---p" w l,     "dosdat.bin.plot" u 2:7 t "DOS---d" w l
...
#Plot total DOS and its angular momentum decompositions
plot "dosdat.bin.plot" u 2:5 t "DOS---s" w l,     "dosdat.bin.plot" u 2:6 t "DOS---p" w l,     "dosdat.bin.plot" u 2:7 t "DOS---eg" w l
...
plot "dosdat.bin.plot" u 2:5 t "DOS---s" w l,     "dosdat.bin.plot" u 2:6 t "DOS---p" w l
